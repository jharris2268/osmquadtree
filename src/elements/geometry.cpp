...
namespace oqt {
GeometryPacked::GeometryPacked(ElementType t, changetype c, int64 i, int64 q, ElementInfo inf, std::vector<Tag> tags, std::optional<int64> minzoom_, std::list<PbfTag> geom_messages_) :
